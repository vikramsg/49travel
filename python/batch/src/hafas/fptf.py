"""
Copied from https://raw.githubusercontent.com/FahrplanDatenGarten/pyhafas/main/pyhafas/types/fptf.py
until available on pip
"""
import datetime
...
class Station(FPTFObject):
    ...
    A station is a point where vehicles stop. It may be a larger building or just a small stop without special
    infrastructure.
...
class Leg(FPTFObject):
    ...
    A leg or also named trip is most times part of a journey and defines a journey with only one specific
    vehicle from A to B.
    ...
    def __init__(
        ...
        :param mode: (optional) Type of transport vehicle - Must be a part of the FPTF `Mode` enum.
